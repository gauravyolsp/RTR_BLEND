...
int main(void)
{
    ...
    struct MyPoint point; // declaraing a single variable of type 'struct MyPoint' locally...

    struct MyPointProperties point_properties; // declaraing a single variable of type 'struct MyPointProperties' locally...
