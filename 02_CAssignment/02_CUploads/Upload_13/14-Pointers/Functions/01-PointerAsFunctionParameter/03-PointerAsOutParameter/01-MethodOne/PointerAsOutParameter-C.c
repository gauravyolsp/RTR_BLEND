...
int main(void)
{
    ...
    // HENCE, ALTHROUGH EACH FUNCTION HAS ONLY ONE RETURN VALUE, USING THE CONCEPT OF 'PARAMETERIZED RETURN VALUES', OUR FUNCTION "MthematicalOperations()" HAS GIVEN US 5 RETURN VALUES !!!
