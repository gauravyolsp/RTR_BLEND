...
int main(void)
{
  ...
  int iStringLength;
  int count_A = 0, count_E = 0, count_I = 0, count_O = 0, count_U = 0; // Initail Counts = 0
  int i;
...
int MyStrlen(char str[])
{
  ...
  //code
  // *** DETERMINIGN EXACT LENGTH OF THE STRING, BY DECTECTING THE FIRST OCCURENCE OF NULL-TERMINATING CHARACTER (\0) ***
