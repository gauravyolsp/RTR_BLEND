...
int main(void)
{
    ...
    printf("Number of elements in 1-D intger array iArray_One = %zu\n", (sizeof(iArray_One) / sizeof(int)));
    ...
    num_rows_3D = (sizeof(iArray_Three) / sizeof(iArray_Three[0][0]));

    printf("Number of elements (columns) in one row in 3-D intger array iArray_Three = %zu\n", (sizeof(iArray_Three[0]) / sizeof(iArray_Three[0][0])));
