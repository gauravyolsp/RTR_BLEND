...
void display(void)
{
	...
	// Translate square Backwards by Z (-ve)
	...
	else if (g_iKeyPressed == 4)
	{
		...
		glTexCoord2f(0.5f, 0.42f);
		glVertex3f(-1.0f, 1.0f, 0.0f);

		glTexCoord2f(0.52f, 0.42f);
		glVertex3f(-1.0f, -1.0f, 0.0f);

		glTexCoord2f(0.52f, 0.5f);
		glVertex3f(1.0f, -1.0f, 0.0f);
