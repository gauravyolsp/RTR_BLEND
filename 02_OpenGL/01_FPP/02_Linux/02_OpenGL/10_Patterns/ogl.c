...
void shape1(void)
{
	...
	glBegin(GL_POINTS);
	float x = -1.4f;
	for (int iCounterX = 0; iCounterX < ROWS; ++iCounterX)
	{
		float y = 0.8f;
		for (int iCounterY = 0; iCounterY < COLUMNS; ++iCounterY)
		{
			glVertex3f(x, y, 0.0f);
...
void shape2(void)
{
	...
	for (int iCounter = 0; iCounter < LINES; iCounter++)
	{
		// Vertical line
...
void shape3(void)
{
	...
	for (int iCounter = 0; iCounter < LINES + 1; iCounter++)
	{
		// Vertical line
		glVertex3f(x, 0.8f, 0.0f);
		glVertex3f(x, 0.2f, 0.0f);
		...
		// Horizontal line
		glVertex3f(0.8f, y, 0.0f);
		glVertex3f(1.4f, y, 0.0f);
