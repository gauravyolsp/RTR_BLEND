...
GLfloat lightDifused0[] = {1.0f, 0.0f, 0.0f, 1.0f};
...
GLfloat lightDifused1[] = { 0.0f, 1.0f, 0.0f, 1.0f };
...
int initilize(void)
{
	...
	glLightfv(GL_LIGHT0, GL_DIFFUSE, lightDifused0);
	...
	glLightfv(GL_LIGHT1, GL_DIFFUSE, lightDifused1);
	...
	glLightfv(GL_LIGHT2, GL_DIFFUSE, lightDifused2);
	glLightfv(GL_LIGHT2, GL_SPECULAR, lightSpecular2);
	glEnable(GL_LIGHT2);

	// Material configuration
	glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT, materialAmbient);
	glMaterialfv(GL_FRONT_AND_BACK, GL_DIFFUSE, materialDifused);
